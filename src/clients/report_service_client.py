...
def update_response_status(report_id:str,response_id: str, is_useful: bool,token:str):
    ...
    try:
        ...
        response = requests.patch(f"{REPORT_SERVICE_URL}/responses/{report_id}/{response_id}/patch", json={"is_useful": is_useful},headers={"Content-Type": "application/json",
                 "Authorization":token})
        response.raise_for_status()
